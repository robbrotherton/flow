...
make_trails_rcpp <- function(particles, flowfields, step_length = 1, max_steps = 1000L, direction = "both", existing_trails = NULL) {
    .Call(`_flow_make_trails_rcpp`, particles, flowfields, step_length, max_steps, direction, existing_trails)
}
