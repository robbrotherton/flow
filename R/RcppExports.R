...
make_trails_rcpp <- function(particles, flowfields, step_length = 1, direction = "both", existing_trails = NULL) {
    .Call(`_flow_make_trails_rcpp`, particles, flowfields, step_length, direction, existing_trails)
}
